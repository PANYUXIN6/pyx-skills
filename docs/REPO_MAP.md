...
- `code-review/`：代码审查路由 skill；当前为用户已有的未跟踪内容，不属于本次迁移。
...
6. 只有人工明确接受的 finding 才能进入 `fix-queue.json`。
...
- `docs/superpowers/specs/2026-08-02-review-design-contracts-migration-design.md`：本次迁移的已确认设计依据。
